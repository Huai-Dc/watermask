 ...
 * 水印效果
 * @author Huai
 * @email 837084459@qq.com
 * Example：
 * <component v-watermark="{content: 'your watermark content'}">
 */
Vue.directive('watermark', (el, binding) => {
    console.log(el)
    _canvasWaterMark(Object.assign({parentNode: el}, binding.value))
})

function _canvasWaterMark ({
    content = 'Watermark', rotate = 30,
    zIndex = 1000, parentNode = document.body,
    width = 300, height = 200, textAlign = 'center', textBaseline = 'middle',
